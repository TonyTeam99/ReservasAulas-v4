...
import org.iesalandalus.programacion.reservasaulas.mvc.modelo.mongodb.utilidades.MongoDB;
...
public class Reservas implements IReservas {
	...
	public List<Reserva> getReservasProfesor(Profesor profesor) {
		...
		for (Document documentoReserva : coleccionReservas.find()
				.filter(eq(MongoDB.PROFESOR_CORREO, profesor.getCorreo()))) {
	...
	public Reserva buscar(Reserva reserva) {
		...
		Document documentoReserva = coleccionReservas.find()
				.filter(and(eq(MongoDB.PROFESOR_CORREO, reserva.getProfesor().getCorreo()),
	...
	public void borrar(Reserva reserva) throws OperationNotSupportedException {
		...
		if (!esMesSiguienteOPosterior(reserva)) {
			throw new OperationNotSupportedException(
					"Sólo se pueden anular reservas para el mes que viene o posteriores.");
		}
		if (buscar(reserva) != null) {
			Bson filtroPermanencia = null;
			if (reserva.getPermanencia() instanceof PermanenciaPorHora) {
			...
			coleccionReservas.deleteOne(and(eq(MongoDB.PROFESOR_CORREO, reserva.getProfesor().getCorreo()),
					eq(MongoDB.AULA_NOMBRE, reserva.getAula().getNombre()),
					eq(MongoDB.PERMANENCIA_DIA, reserva.getPermanencia().getDia().format(MongoDB.FORMATO_DIA)),
					filtroPermanencia));
		} else {
	...
	/*
	 * @Override public List<Reserva> getReservasProfesor(Profesor profesor) { //
	 * TODO Auto-generated method stub return null; }
	 * 
	 * @Override public List<Reserva> getReservasAula(Aula aula) { // TODO
